    ...
    <ul className='flex flex-col gap-2'>
        {allLocations.map((location, index) =>(
            <li className='flex flex-col gap-2 p-2 bg-white' key={index}>
               ...
               <div className='flex items-start'> <Link className='flex items-center gap-1 bg-blue-800 p-2 rounded-[100px] text-white text-[.9rem] font-[500]'>Books <FaArrowRight /></Link></div>
            </li>
        ))}
    </ul>
  )
